        ...
        <div class="card h-100">
          <div class="row">
            ...
            <div class="col-3 text-center">
              <button class="btn btn-primary pt-2 pb-2 w-80" onclick="style.display ='none';location.href='{{ route('drawCard')}}'">1枚引く</button>
            </div>
            <div class="col-3 text-center">
              <button class="btn btn-primary pt-2 pb-2 w-80" onclick="style.display ='none';location.href='{{ route('drawKillCard')}}'">転生札を引く</button>
            </div>
          </div>
        </div>
    </div>
