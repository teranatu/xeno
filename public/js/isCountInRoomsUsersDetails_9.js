...
function inRoomUsers() {
  $.ajax({
      ...
      dataType: "json",
      success: data => {
       // console.log(data.inRoomUsersDetails_9);
        // console.log(data.inRoomUsersDetails_9.length);
        let countUsers = data.inRoomUsersDetails_9.length;
        $("#inRoomUsers").find(".user-visible").remove();

        switch (countUsers) {
          case 1:
            for (var i = 0; i < countUsers; i++) {
              countCard1 = data.inRoomUsersDetails_9[i].card_1;
              countCard2 = data.inRoomUsersDetails_9[i].card_2;
                            ...
                            <div class="col-12 user-visible">
                              <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-4">${data.inRoomUsersDetails_9[i].name}</div>
