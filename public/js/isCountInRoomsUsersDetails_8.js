...
function inRoomUsers() {
  $.ajax({
      ...
      dataType: "json",
      success: data => {
        // console.log(data.inRoomUsersDetails_8);
        // console.log(data.inRoomUsersDetails_8.length);
        let countUsers = data.inRoomUsersDetails_8.length;
        $("#inRoomUsers").find(".user-visible").remove();

        switch (countUsers) {
          case 1:
            for (var i = 0; i < countUsers; i++) {
              countCard1 = data.inRoomUsersDetails_8[i].card_1;
              countCard2 = data.inRoomUsersDetails_8[i].card_2;
